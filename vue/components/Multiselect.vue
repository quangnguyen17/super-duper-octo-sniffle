<template>
    <div
        ...
        :class="[
            isOpen ? 'active' : '',
            disabled ? 'disabled' : '',
            size && size !== 'default' ? 'multiselect-' + size : '',
        ]"
        @focus="activate()"
        ...
        class="multiselect"
    >
        <div ref="tags" class="multiselect-tags">
            <div class="multiselect-tags-list">
                ...
                />
                <span v-if="isSingleLabelVisible" class="multiselect-single" @mousedown.prevent="toggle">
                    <slot name="singleLabel" :option="singleValue">
                        <template>{{ currentOptionLabel }}</template>
                    </slot>
                </span>
                <slot name="placeholder" v-if="isPlaceholderVisible" @mousedown.prevent="toggle">
        ...
        <slot name="loading">
          <div
            ...
            <slot name="caret" :toggle="toggle">
                <div @mousedown.prevent.stop="toggle()" class="multiselect-tags-append multiselect-caret" />
            </slot>
        </div>
        <div
...
export default {
    ...
    computed: {
        ...
        dropdownClasses() {
            ...
            return ["dropdown-menu", this.dropup ? "dropup" : "", this.isOpen ? "show" : "", position];
        },
    },
    watch: {
        isOpen(state, old) {
    ...
    methods: {
        ...
        showMenu() {
            ...
            this.removePopper();
            this._popper = new Popper(element, this.$refs.list, this.getPopperConfig());
